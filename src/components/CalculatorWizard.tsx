...
import { ChevronLeft, ChevronRight, Send, Loader2, Check, User, Building2, Package, MapPin, Users, Wallet, FileText, Wrench, Tag } from 'lucide-react';
      ...
      case 7:
        return (
          <div className="space-y-4">
            ...
            <div className="mt-6 p-4 rounded-lg border border-primary/30 bg-background/30">
              <h4 className="font-medium mb-3">📋 Итоговые данные:</h4>
      ...
      <div className="steampunk-border p-4 md:p-6 relative" style={{ minHeight: '500px' }}>
        ...
        <div className="mb-6">
          <div className="flex justify-between text-xs text-muted-foreground mb-2">
            <span>Шаг {currentStep} из 7</span>
